...
import com.example.yf.ijkplayerdemo.application.AppActivity;
import com.example.yf.ijkplayerdemo.fragments.SampleMediaListFragment;
...
public class SampleMediaActivity extends AppActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        transaction.replace(R.id.by, newFragment);
        transaction.commit();
    }
